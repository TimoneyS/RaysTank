...
public abstract class Tank implements BaseItem {
    ...
    protected boolean     alive                  = true;               // 生存标志
    protected Location    location;
    protected double      moveSpeed;                                   // 移动速度

    protected double      weelState              = 0;                  // 履带动态效果
    protected Color       color;                                       // 颜色
    protected Collision tankCollision          = new TankCollision();
    protected TankMove    tankMove               = new TankMove();
